...
const bullets = ["배송/정책 문의", "플랜 커스터마이즈", "작가·브랜드 협업"];
  ...
  return (
    <Section id="contact" variant="muted">
      <SectionTitle
        eyebrow="CONTACT"
        title="문의 및 콜라보 제안"
        subtitle="배송 일정 조율, 플랜 커스터마이즈, 작가·브랜드 협업을 환영합니다."
      />
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="flex flex-col gap-4">
          <Card className="flex flex-col gap-3 p-5">
            ...
            <p className="text-sm text-muted">가장 빠른 채널로 연결하세요. 영업일 기준 24시간 내 답변을 드립니다.</p>
            ...
            <p className="text-xs text-muted">
              배송 조율, 기업/행사 큐레이션, 작가 콜라보 제안을 위한 전용 채널입니다.
            </p>
          </Card>
        </div>

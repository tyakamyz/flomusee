...
- `/`  
  - 메인 랜딩 페이지  
  - 히어로 섹션 + 서비스 요약 + 대표 구독 플랜 하이라이트
- `/about`  
  - FLOMUSÉE 브랜드 스토리, 미션, 이름의 의미, 팀/철학 소개
- `/artists`  
  - 협업 작가 목록 및 소개
- `/subscribe`  
  - 구독 상품/플랜 상세, 가격, 배송 주기, 포함 구성, FAQ
- `/contact` (옵션)  
  - 문의/콜라보 제안 안내 및 폼
- `/blog` (향후 추가)  
...
- **HeroSection**
  - 메인 카피: FLOMUSÉE 정체성을 한 줄로 표현
  - 서브 카피: “꽃과 예술이 만나는 구독 뮤지엄” 등
  - 주요 CTA 버튼: “구독 플랜 보기” (`/subscribe`로 이동)
- **HowItWorksSection**
  - 서비스 이용 흐름 (예시 4단계):
    1. 테마/작가 큐레이션
    2. 플라워 & 아트 요소 구성
